...
public class Formulario extends JFrame {
	...
	public Formulario() {
		...
		lblMinTemp.setBounds(93, 42, 143, 23);
		...
		lblMaxTemp.setBounds(407, 48, 132, 14);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(negativo == false || menorMil == false) {
					...
					lblRecordeQuebrado.setText("A quantidade de recordes quebrados é " + Controle.recordesQuebrados());
		...
		scrollPane.setBounds(10, 165, 725, 200);
